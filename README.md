...
|SHUFFLE MEMORIES機能<br>このボタンを押すとあなたが登録した推しの写真がランダムで返ってくるよ！！<br>これで隙間時間に簡単に写真が振り返れるね</p> | 🌟Find a photo機能🌟<br> このボタンを押すとあなた登録した写真の撮影日が簡単に探せます 例えば、「去年の推しの誕生日写真を探したい！！」そんな時に簡単探せます💕 | 🌟アルバム公開機能🌟 あなたが作成したアルバムはみんなに公開することができるよ✨X（旧Twitter）に共有できるからみんなに推しを自慢しよう!!　|
| ---- | ---- | ---- |
