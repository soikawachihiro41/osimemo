  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    overlayOptions.addEventListener("change", function(event) {
      if (event.target.value === "heart_stamp") {
        overlayInput.value = "https://res.cloudinary.com/di6l3gth2/image/upload/v1700365647/bdae9b71a0f463997c342fb282c57426_t_utgw9l.jpg";
        const previewImage = document.querySelector("#image-preview-container img");
        if (previewImage) {
          const heartStamp = document.createElement("img");
          heartStamp.src = "https://res.cloudinary.com/di6l3gth2/image/upload/v1700365647/bdae9b71a0f463997c342fb282c57426_t_utgw9l.jpg";
